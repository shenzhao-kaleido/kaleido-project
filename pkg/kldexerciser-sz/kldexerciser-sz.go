...
func (e *Exerciser) Start() (err error) {
	// fmt.Println(e.Accounts, len(e.Accounts))
	// fmt.Println(e.Args, len(e.Args))
	// if len(e.Args) == 1 {
	// 	fmt.Println(e.Args[0], len(e.Args[0]))
	// 	return nil
	// }
	...
	// fmt.Println("sz check compiled", compiled)
	if err != nil {
		return err
	}
	...
	// fmt.Println("sz test for worksers: ", workers)
	return nil
}
